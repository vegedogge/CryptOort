//编译指令g++ -o test_paillier ./libpaillier-0.8/paillier.c test_paillier.cpp -lgmp
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
#include <gmp.h>
...
int main()
{
    ...
    paillier_ciphertext_t ct3;
    mpz_init_set_d(ct3.c, 2);
    paillier_mul(pk, &ct3, &ct, &ct2);
    cout<<"secure multiplication sccess! cyphertext: "; cout<<*ct3.c->_mp_d<<endl;
    paillier_dec(&pt_new, pk, sk, &ct3);
    cout<<"secure multiplication sccess! result: "; cout<<*pt_new.m->_mp_d<<endl;
