...
CC = gcc
CFLAGS  = -O3 -Wall  -DPACKAGE_NAME=\"libpaillier\" -DPACKAGE_TARNAME=\"libpaillier\" -DPACKAGE_VERSION=\"0.8\" -DPACKAGE_STRING=\"libpaillier\ 0.8\" -DPACKAGE_BUGREPORT=\"bethenco@cs.berkeley.edu\" -DPACKAGE_URL=\"\" -DSTDC_HEADERS=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_MEMORY_H=1 -DHAVE_STRINGS_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_UNISTD_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_STDLIB_H=1 -DHAVE_MALLOC=1 -DHAVE_STDLIB_H=1 -DHAVE_REALLOC=1 -DHAVE_MEMSET=1 -DHAVE_GMP=1
LDFLAGS = -O3 -Wall -lgmp 
